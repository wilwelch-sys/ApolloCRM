...
const GSHEET_URL = 'https://script.google.com/macros/s/AKfycbw_cePImmgM0ZcJBPtFdb_qAN3gIBHRt78WDP-x8BpkiXaC8-NR7bScuCMqaStWi5IH/exec';

// ── Google Sheets Sync ────────────────────────────────────────────────────────
// Customer data is stored in Google Sheets — not in the browser
// All team members see the same live customer data
...
const DEFAULT_MFRS = [
  ...
  { id: 'triwest',  name: 'Tri West',        rep: 'Ryan Poole', phone: '', email: '', portal: '', notes: 'Furniture Distributors Inc — Account 001866',
    pdfs: [
      ...
      { file: '_REPS___PED__PAF_COMM_PRICE_LIST_02-11-2026.pdf', label: 'Protect-All Commercial (PED) Price List — Feb 2026' },
    ]
  },
  { id: 'moxie', name: 'Moxie Distribution (Happy Feet)', rep: 'Jace Frazier', phone: '520-697-3868', email: 'jfrazier@moxieflooring.com', portal: '', notes: 'Order Desk: 480-426-9009 (9AM-5PM EST M-F) · Send orders to orders@moxieflooring.com or jfrazier@moxieflooring.com · Account MXD10050',
    pdfs: [
      { file: '/pdfs/Customer_Pricing_-_MXD10050_Apollo_Flooring_-_NetSuite__Moxie_Distribution_.pdf', label: 'Moxie Distribution Apollo Flooring Customer Pricing (MXD10050) — Updated June 2026' },
      { file: '/pdfs/AquaProof_Price_List_12-2-2024__2_.pdf', label: 'AquaProof Laminate Collection (Big D Distributor) — Price List' },
    ]
  },
];
...
const DEFAULT_SHEETS = [
  {
    id: 'sheet-moxie-2026',
    mfrId: 'moxie',
    name: 'Moxie Distribution (Happy Feet) — Apollo Pricing MXD10050',
    effectiveDate: '2026-06-16',
    items: [
      {"service": "Alehouse — VPC · 26.00 SQFT/CTN", "price": "$5.32/sf"},
      {"service": "All Star — Vinyl, 12mil wear, 7.36\"x48.3\" · 49.40 SQFT/CTN", "price": "$0.89/sf"},
      {"service": "All Star II — Virgin PVC, 12mil wear, 7\"x48\" · 51.39 SQFT/CTN", "price": "$0.89/sf"},
      {"service": "Ambitious — Vinyl, 12mil wear, 7\"x48\" · 51.39 SQFT/CTN", "price": "$0.89/sf"},
      {"service": "Arrival 10 — EVA Blue Pad, 10mm, 7.68\"x47.83\" · 25.50 SQFT/CTN", "price": "$1.49/sf"},
      {"service": "Aspen — SPC, 8mm, 9\"x60\", 20mil wear · 23.39 SQFT/CTN", "price": "$2.85/sf"},
      {"service": "Atlas — PVC/Fiberglass, 4.5mm, 7\"x48\", 20mil wear · 25.72 SQFT/CTN", "price": "$1.89/sf"},
      {"service": "Bella Vista — 22.60 SQFT/CTN", "price": "$3.09/sf"},
      {"service": "Blockbuster Plus — SCC, 4.5mm, 7\"x48\", 12mil wear · 23.64 SQFT/CTN", "price": "$1.39/sf"},
      {"service": "Broadway — Stabilicor Plus, 5mm, 7.2\"x60\", 20mil wear · 24.00 SQFT/CTN", "price": "$1.79/sf"},
      {"service": "Bronco — Stabilicor Plus, 5mm, 7\"x60\", 20mil wear · 29.94 SQFT/CTN", "price": "$1.39/sf"},
      {"service": "Built-Rite — SCC, 6.5mm, 8.98\"x63\", 30mil wear · 19.63 SQFT/CTN", "price": "$2.59/sf"},
      {"service": "Built-Rite II — Stabilicor Plus, 6.5mm, 8.98\"x63\", 30mil wear · 19.63 SQFT/CTN", "price": "$2.59/sf"},
      {"service": "Cascade — Vinyl, 2.5mm, 20mil wear · 39.50 SQFT/CTN", "price": "$1.25/sf"},
      {"service": "Cellar House — 29.86 SQFT/CTN", "price": "$2.19/sf"},
      {"service": "Countryside Oak — 43.00 SQFT/CTN", "price": "$3.45/sf"},
      {"service": "Decathlon — Virgin PVC, 2mm, 7\"x48\", 12mil wear · 51.39 SQFT/CTN", "price": "$0.89/sf"},
      {"service": "Dynamic Fit — Vinyl/Fiberglass, 5mm, 9\"x60\", 28mil wear · 26.25 SQFT/CTN", "price": "$2.79/sf"},
      {"service": "Dynamic Stick — Virgin Vinyl, 3mm, 9\"x60\", 20mil wear · 45.00 SQFT/CTN", "price": "$1.79/sf"},
      {"service": "Dynamite — SCC, 5mm, 7\"x48\", 20mil wear · 21.27 SQFT/CTN", "price": "$1.99/sf"},
      {"service": "Dynamite Plus — SCC, 6.2mm, 7.25\"x48\", 20mil wear · 28.70 SQFT/CTN", "price": "$1.99/sf"},
      {"service": "English Pub — 26.00 SQFT/CTN", "price": "$5.39/sf"},
      {"service": "Farmhouse Manor — 19.12 SQFT/CTN", "price": "$3.79/sf"},
      {"service": "Gladiator LL — PVC/Fiberglass, 5mm, 7\"x48\", 12mil wear · 23.36 SQFT/CTN", "price": "$1.89/sf"},
      {"service": "Grand Chateau — 31.30 SQFT/CTN", "price": "$5.90/sf"},
      {"service": "Ironman — Virgin PVC, 3mm, 6.3\"x48\", 22mil wear · 33.89 SQFT/CTN", "price": "$1.89/sf"},
      {"service": "Marathon III — Virgin PVC, 2mm, 7\"x48\", 6mil wear · 51.39 SQFT/CTN", "price": "$0.69/sf"},
      {"service": "Maverick — SCC, 5.7mm, 7\"x48\", 20mil wear · 28.52 SQFT/CTN", "price": "$1.69/sf"},
      {"service": "Mustang — SCC, 4.5mm, 7\"x48\", 12mil wear · 23.64 SQFT/CTN", "price": "$1.39/sf"},
      {"service": "Norden Home — 12mm, 8.5\"x72\", 30mil wear · 17.73 SQFT/CTN", "price": "$3.45/sf"},
      {"service": "Oak Grove — 23.40 SQFT/CTN", "price": "$4.05/sf"},
      {"service": "Oak Grove Prime — 31.09 SQFT/CTN", "price": "$4.81/sf"},
      {"service": "Olde Tavern — 15.20 SQFT/CTN", "price": "$2.99/sf"},
      {"service": "Olympus — 42.63 SQFT/CTN", "price": "$5.25/sf"},
      {"service": "Perseverance — EVA Pad, 6.5mm, 9\"x60\", 20mil wear · 18.70 SQFT/CTN", "price": "$1.99/sf"},
      {"service": "Pinnacle — WPC, 11.5mm, 7\"x60\", 28mil wear · 20.70 SQFT/CTN", "price": "$3.49/sf"},
      {"service": "Quarry Tile — Virgin PVC, 5mm, 18\"x36\", 28mil wear · 27.00 SQFT/CTN", "price": "$2.99/sf"},
      {"service": "QuickFit — PVC/Fiberglass, 5mm, 9\"x48\", 22mil wear · 24.00 SQFT/CTN", "price": "$2.49/sf"},
      {"service": "Regency — WPC, 8mm, 7\"x59.05\", 20mil wear · 22.96 SQFT/CTN", "price": "$2.59/sf"},
      {"service": "Rescue — SCC, 7mm, 7.2\"x48\", 20mil wear · 19.20 SQFT/CTN", "price": "$2.59/sf"},
      {"service": "Showtime — SCC, 4.5mm, 7\"x48\", 12mil wear · 23.64 SQFT/CTN", "price": "$1.69/sf"},
      {"service": "Skyview — 21.95 SQFT/CTN", "price": "$3.55/sf"},
      {"service": "Stone Elegance II — SCC, 6.2mm, 7.25\"x48\", 20mil wear · 28.70 SQFT/CTN", "price": "$1.99/sf"},
      {"service": "Surfside — WPC, 10mm, 7\"x60\", 20mil wear · 17.52 SQFT/CTN", "price": "$1.90/sf"},
      {"service": "Tenacious 8 — Virgin PVC, 2mm, 7\"x48\", 8mil wear · 51.39 SQFT/CTN", "price": "$0.79/sf"},
      {"service": "Texas Timber — Hardwood, 3/8\" · 38.90 SQFT/CTN", "price": "$3.45/sf"},
      {"service": "Thrive — SCC, 4.5mm, 7\"x48\", 12mil wear · 23.64 SQFT/CTN", "price": "$1.39/sf"},
      {"service": "Titan — PVC/Fiberglass, 4.5mm, 7\"x48\", 20mil wear · 25.72 SQFT/CTN", "price": "$1.89/sf"},
      {"service": "Turnberry Hickory — Engineered Hardwood, 14mm, 7.5\"W × Rnd Lengths · 23.30 SQFT/CTN", "price": "$4.99/sf"},
      {"service": "Turnberry Oak — Engineered Hardwood, 14mm, 7.5\"W × Rnd Lengths · 23.30 SQFT/CTN", "price": "$4.99/sf"},
      {"service": "Urban Designs 12 — Virgin Vinyl, 2mm, 7\"x48\", 12mil wear · 51.39 SQFT/CTN", "price": "$0.89/sf"},
      {"service": "Urban Designs 20 — Virgin Vinyl, 2.5mm, 7\"x48\", 20mil wear · 39.71 SQFT/CTN", "price": "$1.39/sf"},
      {"service": "Urban Designs Click — Stabilicor Plus, 5mm, 7\"x48\", 20mil wear · 23.78 SQFT/CTN", "price": "$1.99/sf"},
      {"service": "Urban Designs LL — Vinyl/Fiberglass, 4.5mm, 7\"x48\", 20mil wear · 25.72 SQFT/CTN", "price": "$1.89/sf"},
    ]
  },
  {
...
{
  "id": "sheet-aquaproof-2024",
  "mfrId": "bigd",
  "name": "AquaProof Laminate Collection — Big D Distributor",
  "effectiveDate": "2024-12-02",
  "items": [
    {"service": "AquaProof 10mm — Prospect Point (AP107PP) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Cedar Knoll (AP107CK) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Sterling (AP107SG) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Mountain Air (AP107MA) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Lighthouse (AP107LH) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Hemlock (AP107HL) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Barkers Point (AP107BP) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Longfellow (AP107LF) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Cornwell (AP107CW) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Arden (AP107AN) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Hilldale (AP107HD) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof 10mm — Fox Hollow (AP107FH) · 10mm core + 2mm foam pad, AC4 wear", "price": "$2.39/sf"},
    {"service": "AquaProof XL 14mm — Andiron (AP149AD) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Cool Beige (AP149CB) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Copen Hills (AP149CH) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Carnelian (AP149CL) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Canoe (AP149CN) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Crescent (AP149CT) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Granville (AP149GV) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Maison (AP149MS) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Paxton (AP149PX) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Sandy Bridge (AP149SB) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Surf Coast (AP149SC) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof XL 14mm — Town House (AP149TH) · 14mm core + 2mm foam pad, AC4 wear, 9.3\"x72\"", "price": "$2.99/sf"},
    {"service": "AquaProof Molding — Quarter Round (94.5\") · 10mm & XL compatible", "price": "$15.00/ea"},
    {"service": "AquaProof Molding — Stair Nose (94.5\") · 10mm & XL compatible", "price": "$24.00/ea"},
    {"service": "AquaProof Molding — End Cap (94.5\") · 10mm & XL compatible", "price": "$24.00/ea"},
    {"service": "AquaProof Molding — Reducer (94.5\") · 10mm compatible", "price": "$15.00/ea"},
    {"service": "AquaProof Molding — T-Mold (94.5\") · 10mm compatible", "price": "$38.00/ea"},
    {"service": "AquaProof XL Molding — Quarter Round (94.5\") · XL compatible", "price": "$15.00/ea"},
    {"service": "AquaProof XL Molding — Stair Nose (94.5\") · XL compatible", "price": "$24.00/ea"},
    {"service": "AquaProof XL Molding — End Cap (94.5\") · XL compatible", "price": "$24.00/ea"},
    {"service": "AquaProof XL Molding — Reducer (94.5\") · XL compatible", "price": "$24.00/ea"},
    {"service": "AquaProof XL Molding — T-Mold (94.5\") · XL compatible", "price": "$59.00/ea"},
    {"service": "MoistureBlock Underlayment (MBLOCK) · Recommended for all installations", "price": "$83.42/ctn"}
  ]
},
{
  "id": "sheet-protectall-2026",
  "mfrId": "triwest",
  "name": "Protect-All Commercial (PED) Price List — Feb 2026",
  "effectiveDate": "2026-02-11",
  "items": [
    {"service": "Protect-All 231229 — Matte sheet, ¼\" Dark Gray, 40sf (Stocking)", "price": "$3.85/sf ($154.00/pc)"},
    {"service": "Protect-All 231223 — Matte square tile, ¼\" Dark Gray, 25sf 5'x5'", "price": "$3.85/sf ($96.25/pc)"},
    {"service": "Protect-All 231224 — Matte interlock tile, ¼\" Dark Gray, 2.25sf 18\"x18\" (Stocking)", "price": "$4.00/sf ($9.00/pc)"},
    {"service": "Protect-All 231225 — Matte square tile, ¼\" Dark Gray, 4sf 2'x2'", "price": "$4.10/sf ($16.40/pc)"},
    {"service": "Protect-All 231227 — Matte roll, ¼\" Dark Gray, 150sf 5'x30'", "price": "$4.50/sf ($675.00/pc)"},
    {"service": "Protect-All 231204 — Matte sheet, ¼\" Light Gray, 40sf (Stocking)", "price": "$3.85/sf ($154.00/pc)"},
    {"service": "Protect-All 231203 — Matte square tile, ¼\" Light Gray, 25sf 5'x5'", "price": "$3.85/sf ($96.25/pc)"},
    {"service": "Protect-All 231209 — Matte interlock tile, ¼\" Light Gray, 2.25sf 18\"x18\"", "price": "$4.00/sf ($9.00/pc)"},
    {"service": "Protect-All 231205 — Matte square tile, ¼\" Light Gray, 4sf 2'x2'", "price": "$4.10/sf ($16.40/pc)"},
    {"service": "Protect-All 231211 — Matte roll, ¼\" Light Gray, 150sf 5'x30'", "price": "$4.50/sf ($675.00/pc)"},
    {"service": "Protect-All 231909 — Matte sheet, ¼\" Black, 40sf (Stocking)", "price": "$5.20/sf ($208.00/pc)"},
    {"service": "Protect-All 231907 — Matte square tile, ¼\" Black, 25sf 5'x5'", "price": "$5.10/sf ($127.50/pc)"},
    {"service": "Protect-All 231910 — Matte interlock tile, ¼\" Black, 2.25sf 18\"x18\" (Stocking)", "price": "$5.45/sf ($12.26/pc)"},
    {"service": "Protect-All 231905 — Matte square tile, ¼\" Black, 4sf 2'x2'", "price": "$5.60/sf ($22.40/pc)"},
    {"service": "Protect-All 231809 — Matte sheet, ¼\" Brown, 40sf", "price": "$5.20/sf ($208.00/pc)"},
    {"service": "Protect-All 231807 — Matte square tile, ¼\" Brown, 25sf 5'x5'", "price": "$5.10/sf ($127.50/pc)"},
    {"service": "Protect-All 231806 — Matte interlock tile, ¼\" Brown, 2.25sf 18\"x18\"", "price": "$5.45/sf ($12.26/pc)"},
    {"service": "Protect-All 231805 — Matte square tile, ¼\" Brown, 4sf 2'x2'", "price": "$5.55/sf ($22.20/pc)"},
    {"service": "Protect-All 231609 — Matte sheet, ¼\" Blue, 40sf", "price": "$5.20/sf ($208.00/pc)"},
    {"service": "Protect-All 231603 — Matte square tile, ¼\" Blue, 25sf 5'x5'", "price": "$5.10/sf ($127.50/pc)"},
    {"service": "Protect-All 231610 — Matte interlock tile, ¼\" Blue, 2.25sf 18\"x18\"", "price": "$5.45/sf ($12.26/pc)"},
    {"service": "Protect-All 231605 — Matte square tile, ¼\" Blue, 4sf 2'x2'", "price": "$5.55/sf ($22.20/pc)"},
    {"service": "Protect-All 231409 — Matte sheet, ¼\" Burgundy, 40sf", "price": "$5.20/sf ($208.00/pc)"},
    {"service": "Protect-All 231403 — Matte square tile, ¼\" Burgundy, 25sf 5'x5'", "price": "$5.10/sf ($127.50/pc)"},
    {"service": "Protect-All 231410 — Matte interlock tile, ¼\" Burgundy, 2.25sf 18\"x18\"", "price": "$5.45/sf ($12.26/pc)"},
    {"service": "Protect-All 231405 — Matte square tile, ¼\" Burgundy, 4sf 2'x2'", "price": "$5.55/sf ($22.20/pc)"},
    {"service": "Protect-All 231709 — Matte sheet, ¼\" Green, 40sf", "price": "$5.20/sf ($208.00/pc)"},
    {"service": "Protect-All 231703 — Matte square tile, ¼\" Green, 25sf 5'x5'", "price": "$5.10/sf ($127.50/pc)"},
    {"service": "Protect-All 231710 — Matte interlock tile, ¼\" Green, 2.25sf 18\"x18\"", "price": "$5.45/sf ($12.26/pc)"},
    {"service": "Protect-All 231705 — Matte square tile, ¼\" Green, 4sf 2'x2'", "price": "$5.55/sf ($22.20/pc)"},
    {"service": "Protect-All 231508 — Matte sheet, ¼\" Terra Cotta, 40sf", "price": "$5.20/sf ($208.00/pc)"},
    {"service": "Protect-All 231509 — Matte square tile, ¼\" Terra Cotta, 25sf 5'x5'", "price": "$5.10/sf ($127.50/pc)"},
    {"service": "Protect-All 231510 — Matte interlock tile, ¼\" Terra Cotta, 2.25sf 18\"x18\"", "price": "$5.45/sf ($12.26/pc)"},
    {"service": "Protect-All 231506 — Matte square tile, ¼\" Terra Cotta, 4sf 2'x2'", "price": "$5.55/sf ($22.20/pc)"},
    {"service": "Protect-All 231348H — Matte sheet, ¼\" Cityscape Ultra (Designer A, heavy scatter), 40sf", "price": "$4.90/sf ($196.00/pc)"},
    {"service": "Protect-All 231345H — Matte square tile, ¼\" Cityscape Ultra (Designer A), 25sf 5'x5'", "price": "$4.85/sf ($121.25/pc)"},
    {"service": "Protect-All 231341H — Matte interlock tile, ¼\" Cityscape Ultra (Designer A), 2.25sf 18\"x18\" (Stocking)", "price": "$5.25/sf ($11.81/pc)"},
    {"service": "Protect-All 231342H — Matte square tile, ¼\" Cityscape Ultra (Designer A), 4sf 2'x2'", "price": "$5.40/sf ($21.60/pc)"},
    {"service": "Protect-All 231358H — Matte sheet, ¼\" Graphite Ultra (Designer A, heavy scatter), 40sf (Stocking)", "price": "$4.90/sf ($196.00/pc)"},
    {"service": "Protect-All 231355H — Matte square tile, ¼\" Graphite Ultra (Designer A), 25sf 5'x5'", "price": "$4.85/sf ($121.25/pc)"},
    {"service": "Protect-All 231351H — Matte interlock tile, ¼\" Graphite Ultra (Designer A), 2.25sf 18\"x18\" (Stocking)", "price": "$5.25/sf ($11.81/pc)"},
    {"service": "Protect-All 231352H — Matte square tile, ¼\" Graphite Ultra (Designer A), 4sf 2'x2'", "price": "$5.40/sf ($21.60/pc)"},
    {"service": "Protect-All 231308 — Matte sheet, ¼\" Graphite (Designer A, light scatter/Nat'l spec), 40sf", "price": "$4.90/sf ($196.00/pc)"},
    {"service": "Protect-All 231368H — Matte sheet, ¼\" Northern Lights Ultra (Designer A, heavy scatter), 40sf", "price": "$4.90/sf ($196.00/pc)"},
    {"service": "Protect-All 231365H — Matte square tile, ¼\" Northern Lights Ultra (Designer A), 25sf 5'x5'", "price": "$4.85/sf ($121.25/pc)"},
    {"service": "Protect-All 231361H — Matte interlock tile, ¼\" Northern Lights Ultra (Designer A), 2.25sf 18\"x18\"", "price": "$5.25/sf ($11.81/pc)"},
    {"service": "Protect-All 231362H — Matte square tile, ¼\" Northern Lights Ultra (Designer A), 4sf 2'x2'", "price": "$5.40/sf ($21.60/pc)"},
    {"service": "Protect-All 232388H — Matte sheet, ¼\" Glacier Ultra (Designer A, heavy scatter), 40sf", "price": "$4.90/sf ($196.00/pc)"},
    {"service": "Protect-All 232385H — Matte square tile, ¼\" Glacier Ultra (Designer A), 25sf 5'x5'", "price": "$4.85/sf ($121.25/pc)"},
    {"service": "Protect-All 232381H — Matte interlock tile, ¼\" Glacier Ultra (Designer A), 2.25sf 18\"x18\" (Stocking)", "price": "$5.25/sf ($11.81/pc)"},
    {"service": "Protect-All 232382H — Matte square tile, ¼\" Glacier Ultra (Designer A), 4sf 2'x2'", "price": "$5.40/sf ($21.60/pc)"},
    {"service": "Protect-All 222222 — Matte roll, ¼\" Glacier Ultra (Designer A), 150sf 5'x30'", "price": "$5.20/sf ($780.00/pc)"},
    {"service": "Protect-All 221232 — Ripple sheet, ¼\" Dark Gray, 40sf (Stocking)", "price": "$4.55/sf ($182.00/pc)"},
    {"service": "Protect-All 221230 — Ripple square tile, ¼\" Dark Gray, 25sf 5'x5'", "price": "$4.35/sf ($108.75/pc)"},
    {"service": "Protect-All 221236 — Ripple interlock tile, ¼\" Dark Gray, 2.25sf 18\"x18\"", "price": "$4.05/sf ($9.11/pc)"},
    {"service": "Protect-All 221234 — Ripple square tile, ¼\" Dark Gray, 4sf 2'x2'", "price": "$4.20/sf ($16.80/pc)"},
    {"service": "Protect-All 221242 — Ripple sheet, ¼\" Black, 40sf (Stocking)", "price": "$5.50/sf ($220.00/pc)"},
    {"service": "Protect-All 865000 — Rapid Weld Tool Kit, Cd Gun/2 Batt/Charger/Case/Finish+ Radius Tool/Handle (Stocking)", "price": "$741.20/ea"},
    {"service": "Protect-All 865010 — Rapid Weld rod, Dark Gray (Stocking)", "price": "$103.60/ea"},
    {"service": "Protect-All 865011 — Rapid Weld rod, Light Gray (Stocking)", "price": "$103.60/ea"},
    {"service": "Protect-All 865012 — Rapid Weld rod, Black (Stocking)", "price": "$106.85/ea"},
    {"service": "Protect-All 865013 — Rapid Weld rod, Brown", "price": "$106.85/ea"},
    {"service": "Protect-All 865014 — Rapid Weld rod, Terra Cotta", "price": "$106.85/ea"},
    {"service": "Protect-All 865015 — Rapid Weld rod, Blue", "price": "$106.85/ea"},
    {"service": "Protect-All 865016 — Rapid Weld rod, Burgundy", "price": "$106.85/ea"},
    {"service": "Protect-All 865017 — Rapid Weld rod, Green", "price": "$125.30/ea"},
    {"service": "Protect-All 865020 — Rapid Weld Gun, Manual", "price": "$106.85/ea"},
    {"service": "Protect-All 865026 — Replacement Battery for Rapid Weld Cordless Gun", "price": "$121.40/ea"},
    {"service": "Protect-All 865027 — Battery Charger for Rapid Weld Cordless Gun Battery", "price": "$121.40/ea"},
    {"service": "Protect-All 865030 — RW Mixing Nozzle, multipack 10pc/pack (Stocking)", "price": "$240.30/ea"},
    {"service": "Protect-All 865032 — Groover Blade 4.7mm, Wolff Groover (Stocking)", "price": "$227.65/ea"},
    {"service": "Protect-All 865033 — Groover Blade 4.7mm, Leister Groover", "price": "$227.65/ea"},
    {"service": "Protect-All 865040 — RW Finish Tool 3-in-1 (Stocking)", "price": "$7.80/ea"},
    {"service": "Protect-All 865041 — RW Finish Tool, Floor Seam (Stocking)", "price": "$1.75/ea"},
    {"service": "Protect-All 865005 — RW Warming Bag, six tube capacity, electric (Stocking)", "price": "$100.80/ea"},
    {"service": "Protect-All 865046 — RW Seam Tape Roll, 120 yds/roll (Stocking)", "price": "$54.55/ea"},
    {"service": "Protect-All 800500 — Seam Sealer Refill 16oz, covers 500lf non-Rapid Weld only (Stocking)", "price": "$34.65/ea"},
    {"service": "Protect-All 800501 — Seam Sealer Applicator, bottle & application tip (Stocking)", "price": "$17.50/ea"},
    {"service": "Protect-All 850396 — PA 295 Adhesive, 1 gallon, 70-90sf/unit (Stocking)", "price": "$120.00/ea"},
    {"service": "Protect-All 850395 — PA 295 Adhesive, 2 gallon, 140-180sf/unit (Stocking)", "price": "$164.50/ea"},
    {"service": "Protect-All 863030 — E6100 Construction Adhesive, case of 12, 25lf/tube @ ¼\" bead (Stocking)", "price": "$94.60/ea"},
    {"service": "Protect-All 864050 — Z-Bar Cove Cap 8' length, Aluminum (Stocking)", "price": "$13.10/ea"},
    {"service": "Protect-All 864052 — Z-Bar Cove Cap 8' length, Dark Gray Vinyl (Stocking)", "price": "$6.90/ea"},
    {"service": "Protect-All 864056A — Pre-notched Z-Bar 12\"x12\", Aluminum inside corner (Stocking)", "price": "$5.10/ea"},
    {"service": "Protect-All 864057A — Pre-notched Z-Bar 12\"x12\", Aluminum outside corner (Stocking)", "price": "$5.10/ea"},
    {"service": "Protect-All 864063 — Rounded Corner Guard 2\"x2\"x4\", Stainless Steel (Stocking)", "price": "$15.85/ea"},
    {"service": "Protect-All 864070 — Transitional strip 2-1/4\"x4', Stainless Steel", "price": "$87.55/ea"},
    {"service": "Protect-All 864073 — Transitional strip 2-1/4\"x8', Stainless Steel (Stocking)", "price": "$164.50/ea"},
    {"service": "Protect-All 864051B — Z-Bar Cove Cap 8' length tube (25ea), Stainless Steel (Stocking)", "price": "$812.15/ea"},
    {"service": "Protect-All 864051 — Z-Bar Cove Cap 8' length, Stainless Steel **special order (Stocking)", "price": "$36.50/ea"},
    {"service": "Protect-All 864058S — Pre-notched Z-Bar 12\"x12\", Stainless Steel inside corner **special order", "price": "$14.65/ea"},
    {"service": "Protect-All 864059S — Pre-notched Z-Bar 12\"x12\", Stainless Steel outside corner **special order", "price": "$14.65/ea"},
    {"service": "Protect-All 864073W — Transitional strip 4-1/4\"x8' extra wide, Stainless Steel **special order", "price": "$381.15/ea"},
    {"service": "Protect-All 864080 — Drain Rings 3\"-8\", Stainless Steel **special order", "price": "$80.00/ea"},
    {"service": "Protect-All 864080618R/864080818R — Stocking Drain Rings Round 6\" & 8\", Stainless Steel", "price": "$80.00/ea"},
    {"service": "Protect-All 864082 — Drain Rings 9\"-12\", Stainless Steel **special order", "price": "$138.05/ea"},
    {"service": "Protect-All 8640821218S — Stocking Drain Ring Square 12\"x12\", Stainless Steel", "price": "$138.05/ea"},
    {"service": "Protect-All 864094 — Trough Drain 13\"-23\", Stainless Steel puzzled **special order", "price": "Custom — per inch"},
    {"service": "Protect-All 864096 — Trough Drain 24\"+, Stainless Steel puzzled **special order", "price": "Custom — per inch"},
    {"service": "Protect-All 864075B — #12 Screws & Anchors 1-1/4\", Stainless Steel, 50/box w/Drill Bit & Driver (Stocking)", "price": "$52.20/ea"},
    {"service": "Protect-All 864076B — #8 Pan Head Screw 1-1/4\", Zinc, 250/box w/Drill Bit & Driver (Stocking)", "price": "$27.95/ea"},
    {"service": "Protect-All 864077B — #8 Pan Head Screw 1-1/4\", Stainless Steel, 250/box w/Drill Bit & Driver (Stocking)", "price": "$27.95/ea"},
    {"service": "Protect-All 864078B — #8 Hex Head Screw 1-1/4\", Stainless Steel, 250/box w/Drill Bit & Driver (Stocking)", "price": "$43.10/ea"},
    {"service": "Protect-All 234001 — Cove Base Roll ¼\"x6\"x30', Dark Gray (Stocking)", "price": "$75.45/ea"},
    {"service": "Protect-All 234002 — Cove Base Roll ¼\"x6\"x30', Light Gray (Stocking)", "price": "$75.45/ea"},
    {"service": "Protect-All 234003 — Cove Base Roll ¼\"x6\"x30', Brown", "price": "$90.90/ea"},
    {"service": "Protect-All 234004 — Cove Base Roll ¼\"x6\"x30', Black", "price": "$90.90/ea"},
    {"service": "Protect-All 234006 — Cove Base Roll ¼\"x6\"x30', Terra Cotta", "price": "$90.90/ea"},
    {"service": "Protect-All 234008 — Cove Base Roll ¼\"x6\"x30', Blue", "price": "$90.90/ea"},
    {"service": "Protect-All 234009 — Cove Base Roll ¼\"x6\"x30', Green", "price": "$90.90/ea"},
    {"service": "Protect-All 231349H — Cove Base Roll ¼\"x6\"x30', Cityscape Ultra", "price": "$90.90/ea"},
    {"service": "Protect-All 231359H — Cove Base Roll ¼\"x6\"x30', Graphite Ultra", "price": "$90.90/ea"},
    {"service": "Protect-All 231314 — Cove Base Roll ¼\"x6\"x30', Graphite (Nat'l spec)", "price": "$90.90/ea"},
    {"service": "Protect-All 231369H — Cove Base Roll ¼\"x6\"x30', Northern Lights Ultra", "price": "$90.90/ea"},
    {"service": "Protect-All 231229G — Gloss sheet, ¼\" Dark Gray, 40sf", "price": "$4.65/sf ($186.00/pc)"},
    {"service": "Protect-All 231223G — Gloss square tile, ¼\" Dark Gray, 25sf 5'x5'", "price": "$4.50/sf ($112.50/pc)"},
    {"service": "Protect-All 231224G — Gloss interlock tile, ¼\" Dark Gray, 2.25sf 18\"x18\"", "price": "$4.80/sf ($10.80/pc)"},
    {"service": "Protect-All 231225G — Gloss square tile, ¼\" Dark Gray, 4sf 2'x2'", "price": "$4.90/sf ($19.60/pc)"},
    {"service": "Protect-All 231204G — Gloss sheet, ¼\" Light Gray, 40sf", "price": "$4.65/sf ($186.00/pc)"},
    {"service": "Protect-All 231203G — Gloss square tile, ¼\" Light Gray, 25sf 5'x5'", "price": "$4.50/sf ($112.50/pc)"},
    {"service": "Protect-All 231209G — Gloss interlock tile, ¼\" Light Gray, 2.25sf 18\"x18\"", "price": "$4.80/sf ($10.80/pc)"},
    {"service": "Protect-All 231205G — Gloss square tile, ¼\" Light Gray, 4sf 2'x2'", "price": "$4.90/sf ($19.60/pc)"},
    {"service": "Protect-All 231909G — Gloss sheet, ¼\" Black, 40sf", "price": "$5.70/sf ($228.00/pc)"},
    {"service": "Protect-All 231907G — Gloss square tile, ¼\" Black, 25sf 5'x5'", "price": "$5.65/sf ($141.25/pc)"},
    {"service": "Protect-All 231910G — Gloss interlock tile, ¼\" Black, 2.25sf 18\"x18\"", "price": "$5.75/sf ($12.94/pc)"},
    {"service": "Protect-All 231905G — Gloss square tile, ¼\" Black, 4sf 2'x2'", "price": "$5.90/sf ($23.60/pc)"},
    {"service": "Protect-All 231809G — Gloss sheet, ¼\" Brown, 40sf", "price": "$5.70/sf ($228.00/pc)"},
    {"service": "Protect-All 231807G — Gloss square tile, ¼\" Brown, 25sf 5'x5'", "price": "$5.65/sf ($141.25/pc)"},
    {"service": "Protect-All 231806G — Gloss interlock tile, ¼\" Brown, 2.25sf 18\"x18\"", "price": "$5.75/sf ($12.94/pc)"},
    {"service": "Protect-All 231805G — Gloss square tile, ¼\" Brown, 4sf 2'x2'", "price": "$5.90/sf ($23.60/pc)"},
    {"service": "Protect-All 231609G — Gloss sheet, ¼\" Blue, 40sf", "price": "$5.70/sf ($228.00/pc)"},
    {"service": "Protect-All 231603G — Gloss square tile, ¼\" Blue, 25sf 5'x5'", "price": "$5.65/sf ($141.25/pc)"},
    {"service": "Protect-All 231610G — Gloss interlock tile, ¼\" Blue, 2.25sf 18\"x18\"", "price": "$5.75/sf ($12.94/pc)"},
    {"service": "Protect-All 231605G — Gloss square tile, ¼\" Blue, 4sf 2'x2'", "price": "$5.90/sf ($23.60/pc)"},
    {"service": "Protect-All 231409G — Gloss sheet, ¼\" Burgundy, 40sf", "price": "$5.70/sf ($228.00/pc)"},
    {"service": "Protect-All 231403G — Gloss square tile, ¼\" Burgundy, 25sf 5'x5'", "price": "$5.65/sf ($141.25/pc)"},
    {"service": "Protect-All 231410G — Gloss interlock tile, ¼\" Burgundy, 2.25sf 18\"x18\"", "price": "$5.75/sf ($12.94/pc)"},
    {"service": "Protect-All 231405G — Gloss square tile, ¼\" Burgundy, 4sf 2'x2'", "price": "$5.90/sf ($23.60/pc)"},
    {"service": "Protect-All 231709G — Gloss sheet, ¼\" Green, 40sf", "price": "$5.70/sf ($228.00/pc)"},
    {"service": "Protect-All 231703G — Gloss square tile, ¼\" Green, 25sf 5'x5'", "price": "$5.65/sf ($141.25/pc)"},
    {"service": "Protect-All 231710G — Gloss interlock tile, ¼\" Green, 2.25sf 18\"x18\"", "price": "$5.75/sf ($12.94/pc)"},
    {"service": "Protect-All 231705G — Gloss square tile, ¼\" Green, 4sf 2'x2'", "price": "$5.90/sf ($23.60/pc)"},
    {"service": "Protect-All 231508G — Gloss sheet, ¼\" Terra Cotta, 40sf", "price": "$5.70/sf ($228.00/pc)"},
    {"service": "Protect-All 231509G — Gloss square tile, ¼\" Terra Cotta, 25sf 5'x5'", "price": "$5.65/sf ($141.25/pc)"},
    {"service": "Protect-All 231510G — Gloss interlock tile, ¼\" Terra Cotta, 2.25sf 18\"x18\"", "price": "$5.75/sf ($12.94/pc)"},
    {"service": "Protect-All 231506G — Gloss square tile, ¼\" Terra Cotta, 4sf 2'x2'", "price": "$5.90/sf ($23.60/pc)"},
    {"service": "Protect-All 231348HG — Gloss sheet, ¼\" Cityscape Ultra (Designer), 40sf", "price": "$5.75/sf ($230.00/pc)"},
    {"service": "Protect-All 231345HG — Gloss square tile, ¼\" Cityscape Ultra (Designer), 25sf 5'x5'", "price": "$5.70/sf ($142.50/pc)"},
    {"service": "Protect-All 231341HG — Gloss interlock tile, ¼\" Cityscape Ultra (Designer), 2.25sf 18\"x18\"", "price": "$5.90/sf ($13.28/pc)"},
    {"service": "Protect-All 231342HG — Gloss square tile, ¼\" Cityscape Ultra (Designer), 4sf 2'x2'", "price": "$6.05/sf ($24.20/pc)"},
    {"service": "Protect-All 231358HG — Gloss sheet, ¼\" Graphite Ultra (Designer), 40sf", "price": "$5.75/sf ($230.00/pc)"},
    {"service": "Protect-All 231355HG — Gloss square tile, ¼\" Graphite Ultra (Designer), 25sf 5'x5'", "price": "$5.70/sf ($142.50/pc)"},
    {"service": "Protect-All 231351HG — Gloss interlock tile, ¼\" Graphite Ultra (Designer), 2.25sf 18\"x18\"", "price": "$5.90/sf ($13.28/pc)"},
    {"service": "Protect-All 231352HG — Gloss square tile, ¼\" Graphite Ultra (Designer), 4sf 2'x2'", "price": "$6.05/sf ($24.20/pc)"},
    {"service": "Protect-All 231368HG — Gloss sheet, ¼\" Northern Lights Ultra (Designer), 40sf", "price": "$5.75/sf ($230.00/pc)"},
    {"service": "Protect-All 231365HG — Gloss square tile, ¼\" Northern Lights Ultra (Designer), 25sf 5'x5'", "price": "$5.70/sf ($142.50/pc)"},
    {"service": "Protect-All 231361HG — Gloss interlock tile, ¼\" Northern Lights Ultra (Designer), 2.25sf 18\"x18\"", "price": "$5.90/sf ($13.28/pc)"},
    {"service": "Protect-All 231362HG — Gloss square tile, ¼\" Northern Lights Ultra (Designer), 4sf 2'x2'", "price": "$6.05/sf ($24.20/pc)"},
    {"service": "Protect-All 230229 — Matte sheet, ⅛\" Dark Gray, 40sf (Stocking)", "price": "$2.55/sf ($102.00/pc)"},
    {"service": "Protect-All 230225 — Matte square tile, ⅛\" Dark Gray, 4sf 2'x2'", "price": "$3.10/sf ($12.40/pc)"},
    {"service": "Protect-All 230228 — Matte roll, ⅛\" Dark Gray, 150sf 5'x30'", "price": "$2.90/sf ($435.00/pc)"},
    {"service": "Protect-All 230204 — Matte sheet, ⅛\" Light Gray, 40sf (Stocking)", "price": "$2.55/sf ($102.00/pc)"},
    {"service": "Protect-All 230207 — Matte square tile, ⅛\" Light Gray, 4sf 2'x2'", "price": "$3.10/sf ($12.40/pc)"},
    {"service": "Protect-All 230206 — Matte roll, ⅛\" Light Gray, 150sf 5'x30'", "price": "$2.90/sf ($435.00/pc)"},
    {"service": "Protect-All 230909 — Matte sheet, ⅛\" Black, 40sf (Stocking)", "price": "$2.90/sf ($116.00/pc)"},
    {"service": "Protect-All 230905 — Matte square tile, ⅛\" Black, 4sf 2'x2'", "price": "$3.70/sf ($14.80/pc)"},
    {"service": "Protect-All 230928 — Matte roll, ⅛\" Black, 150sf 5'x30'", "price": "$3.30/sf ($495.00/pc)"},
    {"service": "Protect-All 230809 — Matte sheet, ⅛\" Brown, 40sf", "price": "$2.90/sf ($116.00/pc)"},
    {"service": "Protect-All 230805 — Matte square tile, ⅛\" Brown, 4sf 2'x2'", "price": "$3.70/sf ($14.80/pc)"},
    {"service": "Protect-All 230609 — Matte sheet, ⅛\" Blue, 40sf", "price": "$2.90/sf ($116.00/pc)"},
    {"service": "Protect-All 230604 — Matte square tile, ⅛\" Blue, 4sf 2'x2'", "price": "$3.70/sf ($14.80/pc)"},
    {"service": "Protect-All 230409 — Matte sheet, ⅛\" Burgundy, 40sf", "price": "$2.90/sf ($116.00/pc)"},
    {"service": "Protect-All 230404 — Matte square tile, ⅛\" Burgundy, 4sf 2'x2'", "price": "$3.70/sf ($14.80/pc)"},
    {"service": "Protect-All 230709 — Matte sheet, ⅛\" Green, 40sf", "price": "$2.90/sf ($116.00/pc)"},
    {"service": "Protect-All 230704 — Matte square tile, ⅛\" Green, 4sf 2'x2'", "price": "$3.70/sf ($14.80/pc)"},
    {"service": "Protect-All 230508 — Matte sheet, ⅛\" Terra Cotta, 40sf", "price": "$2.90/sf ($116.00/pc)"},
    {"service": "Protect-All 230506 — Matte square tile, ⅛\" Terra Cotta, 4sf 2'x2'", "price": "$3.70/sf ($14.80/pc)"},
    {"service": "Protect-All Designer Series Option B — Premix: 1 Base Color + 1 Standard Fleck · No min on Black or Dark/Light Gray base; 4,000sf min other base colors", "price": "$4.95–$5.40/sf"},
    {"service": "Protect-All Designer Series Option C — Custom: 1 Base Color + up to 3 Fleck Choices · 4,000sf min all base colors", "price": "$4.90–$5.90/sf (scales w/ fleck count)"},
    {"service": "Protect-All Designer Series Option B Standard Fleck Choices — Red & White, Orange & Terra Cotta, Light Purple & Dark Gray, Tan & Terra Cotta, Green & White, Yellow & Blue, Purple & Dark Gray, Yellow & White, Dark Gray & White, Tan & White", "price": "See Option B pricing"},
    {"service": "Protect-All Designer Series — Gloss finish and custom samples available upon request (¼\" only)", "price": "Call for pricing"}
  ]
}
];
...
async function loadFromGoogleSheets() {
  try {
    showSyncStatus('🔄 Loading customer data...');
    const resp = await fetch(GSHEET_URL + '?t=' + Date.now(), { method: 'GET' });
    const data = await resp.json();
    if (data.success && data.customers && data.customers.length > 0) {
      state.customers = data.customers.map(function(c) {
        return {
          id: c.ID || gid(),
          name: c.Name || '',
          phone: c.Phone || '',
          ...
          amount: c.Amount || '',
          notes: c.Notes ? [{id:gid(),text:c.Notes,createdAt:c.CreatedAt||new Date().toISOString()}] : [],
          orders: [],
      ...
      showSyncStatus('📋 No customers found in database');
    }
  } catch(e) {
    console.warn('Google Sheets load error', e);
    showSyncStatus('⚠️ Using local data — check connection');
  }
}
...
function load() {
  try {
    ...
    if (raw) {
      ...
      // customers now loaded from Google Sheets only
      ...
      // Also ensure all default manufacturers are in the mfr directory
      // (back-fills any manufacturer added to DEFAULT_MFRS after the user's
      // localStorage was first created, e.g. Moxie)
      var defaultMfrIds = DEFAULT_MFRS.map(function(m) { return m.id; });
      defaultMfrIds.forEach(function(id) {
        ...
        if (!exists) {
          ...
          // Update existing entry's pdfs/notes if the default was enriched
          // (e.g. Moxie gaining the AquaProof PDF link) but preserve any
          // user edits to rep/phone/email/portal
          var idx = state.mfrs.findIndex(function(m) { return m.id === id; });
          var def = DEFAULT_MFRS.find(function(m) { return m.id === id; });
          if (idx !== -1 && def && def.pdfs) {
            var existingPdfFiles = (state.mfrs[idx].pdfs || []).map(function(p){ return p.file; });
            var missingPdfs = def.pdfs.filter(function(p){ return existingPdfFiles.indexOf(p.file) === -1; });
            if (missingPdfs.length) {
              state.mfrs[idx] = Object.assign({}, state.mfrs[idx], {
                pdfs: (state.mfrs[idx].pdfs || []).concat(missingPdfs)
              });
            }
          }
        }
...
function saveLocal() {
  try {
    localStorage.setItem(SK, JSON.stringify({ mfrs: state.mfrs, sheets: state.sheets, revenueGoal: state.revenueGoal }));
...
async function saveCustomerToSheets(customer) {
  try {
    const payload = {
      ...
      notes: (customer.notes||[]).map(function(n){return n.text;}).join(' | '),
    ...
    showSyncStatus('✅ Customer saved to database');
  } catch(e) {
    console.warn('Google Sheets save error', e);
    showSyncStatus('⚠️ Could not save to database');
  }
}
...
function importData(file) {
  ...
  reader.onload = e => {
    try {
      ...
      if (d.mfrs)         state.mfrs         = d.mfrs;
      // Back-fill any default manufacturers missing from the imported file
      DEFAULT_MFRS.forEach(function(dm) {
        var exists = state.mfrs.some(function(m) { return m.id === dm.id; });
        if (!exists) state.mfrs.push(dm);
      });
...
function init() {
  ...
  document.getElementById('wi-save').onclick = function() {
    ...
    save(); saveCustomerToSheets(c); closeModal('modal-walkin'); render(); toast(name + ' logged!');
  };
  ...
  document.getElementById('ac-save').onclick = function() {
    ...
    state.customers.unshift(c);
    save(); saveCustomerToSheets(c); closeModal('modal-addcust'); render(); toast(name + ' added!');
  };
