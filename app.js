...
const DEFAULT_MFRS = [
  ...
  { id: 'moxie', name: 'Moxie Distribution (Happy Feet)', rep: 'Jace Frazier', phone: '520-697-3868', email: 'jfrazier@moxieflooring.com', portal: '', notes: 'Order Desk: 480-426-9009 (9AM-5PM EST M-F) · Send orders to orders@moxieflooring.com or jfrazier@moxieflooring.com · Account MXD10050',
    pdfs: [
      { file: 'Customer_Pricing_-_MXD10050_Apollo_Flooring_-_NetSuite__Moxie_Distribution_.pdf', label: 'Moxie Distribution Apollo Flooring Customer Pricing (MXD10050) — Updated June 2026' },
      { file: 'AquaProof_Price_List_12-2-2024__2_.pdf', label: 'AquaProof Laminate Collection (Big D Distributor) — Price List' },
    ]
  },
];
