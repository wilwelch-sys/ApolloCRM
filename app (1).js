...
const DEFAULT_MFRS = [
  ...
  { id: 'bigd', name: 'Big D Floor Covering Supplies', rep: 'Sean Webner', phone: '602-442-2299', email: '', portal: '', notes: 'Order Desk: (602) 442-2299 · Tarkett FiberFloor/TruTex distributor',
    pdfs: [
...
},
{
  ...
  "items": [
    ...
    {"service": "Armstrong SPC Quarter Round Trim — 94\" length", "price": "$8.98/ea"},
    ...
    {"service": "Armstrong S299-108 Sheet Adhesive — 220-260 SF/gal, each", "price": "$46.68/ea"},
    {"service": "Armstrong S299-418 Sheet Adhesive — 220-260 SF/gal, 4-gal pail", "price": "$171.25/pail"},
    {"service": "Armstrong S295-108 Sheet Adhesive — 220-260 SF/gal, each", "price": "$41.42/ea"},
    {"service": "Armstrong S295-418 Sheet Adhesive — 220-260 SF/gal, 4-gal pail", "price": "$171.25/pail"},
    {"service": "Armstrong S-761 Seam Adhesive — Fiber Glass Back", "price": "$14.65/ea"},
    {"service": "Armstrong S-309 New Beginning Deep Cleaning Stripper — 1 qt, 12/ctn", "price": "$110.66/ctn"},
    {"service": "Armstrong S-330 Once N Done Cleaner No-Rinse — 1 qt, 12/ctn", "price": "$93.66/ctn"},
    {"service": "Armstrong S-330 Once N Done Cleaner No-Rinse — 1 gal, 4/ctn", "price": "$84.70/ctn"},
    {"service": "Armstrong S-338 Once N Done Cleaner Concentrate — 1 qt, 12/ctn", "price": "$98.30/ctn"},
    {"service": "Armstrong S-338 Once N Done Cleaner Concentrate — 1 gal, 4/ctn", "price": "$106.34/ctn"},
    {"service": "Armstrong S-390 Shine Keeper Floor Polish — 1 qt, 12/ctn", "price": "$106.03/ctn"},
    {"service": "Armstrong S-390 Shine Keeper Floor Polish — 1/2 gal, 8/ctn", "price": "$165.07/ctn"},
    {"service": "Armstrong S-391 Shine Keeper Resilient Floor Finish — 32 oz, 6/ctn", "price": "$85.94/ctn"},
...
},
{
  ...
  "effectiveDate": "2026-05-05",
  "items": [
    {"service": "Armstrong Medintone w/D10 — Commercial Homogeneous Sheet, 6.5', Roll", "price": "$29.99/SY"},
    {"service": "Armstrong Medintone w/D10 — Commercial Homogeneous Sheet, 6.5', Cut", "price": "$31.99/SY"},
    {"service": "Armstrong Medinpure w/D10 — Commercial Homogeneous Sheet, 6.56', Roll", "price": "$73.67/SY"},
    {"service": "Armstrong Medinpure w/D10 — Commercial Homogeneous Sheet, 6.56', Cut", "price": "$75.67/SY"},
    {"service": "Armstrong Natralis — Commercial Homogeneous Sheet, 6', Roll", "price": "$44.99/SY"},
    {"service": "Armstrong Natralis — Commercial Homogeneous Sheet, 6', Cut", "price": "$46.99/SY"},
    {"service": "Armstrong Nidra — Commercial Homogeneous Sheet, 6.56', Roll", "price": "$38.99/SY"},
    {"service": "Armstrong Nidra — Commercial Homogeneous Sheet, 6.56', Cut", "price": "$40.99/SY"},
    {"service": "Armstrong Zenscape — Commercial Homogeneous Sheet, 6.56', Roll", "price": "$38.99/SY"},
    {"service": "Armstrong Zenscape — Commercial Homogeneous Sheet, 6.56', Cut", "price": "$40.99/SY"},
    {"service": "Armstrong Crown Texture 1/8\" — Commercial VCT, 45 SF/ctn", "price": "$1.87/SF"},
    {"service": "Armstrong Imperial Texture & Multicolor 1/8\" — Commercial VCT, 45 SF/ctn", "price": "$1.69/SF"},
    {"service": "Armstrong Stonetex Premium Excelon — Commercial VCT, 45 SF/ctn", "price": "$3.57/SF"},
    {"service": "Armstrong Safety Zone — Commercial VCT, 45 SF/ctn", "price": "$7.17/SF"},
    {"service": "Armstrong Excelon SDT Static Dissipative Tile — 45 SF/ctn", "price": "$8.02/SF"},
    {"service": "Armstrong Feature Tile Group I Black — Commercial VCT, 45 SF/ctn", "price": "$6.43/SF"},
    {"service": "Armstrong Feature Tile Group II All Others — Commercial VCT, 45 SF/ctn", "price": "$7.92/SF"},
    {"service": "Armstrong Feature Strip 2\"x24\" — 48 lineal feet", "price": "$142.88/pkg"},
    {"service": "Armstrong Feature Strip 4\"x24\" (200') — Special Order", "price": "$1,372.75"},
    {"service": "Armstrong Feature Strip 6\"x24\" (100') — Special Order", "price": "$1,032.69"},
    {"service": "Armstrong Basketball Court 1/8\" #50517 — Black", "price": "$2,171.55"},
    {"service": "Armstrong Shuffleboard Unit #50509-831 (3x3'9) — R/W/B", "price": "$532.47"},
    {"service": "Armstrong Parallel USA 20mil Plank — LVT Commercial, 6\"x48\", 36 SF/ctn", "price": "$1.85/SF"},
    {"service": "Armstrong Parallel USA 20mil Tile — LVT Commercial, 18\"x18\", 36 SF/ctn", "price": "$1.85/SF"},
    {"service": "Armstrong Parallel USA 12mil Plank — LVT Commercial, 6\"x48\", 36 SF/ctn", "price": "$1.62/SF"},
    {"service": "Armstrong Parallel USA 12mil Tile — LVT Commercial, 18\"x18\", 36 SF/ctn", "price": "$1.62/SF"},
    {"service": "Armstrong Unify 20mil Plank — LVT Commercial, 6\"x36\", 36 SF/ctn", "price": "$2.67/SF"},
    {"service": "Armstrong Unify 20mil Plank — LVT Commercial, 6\"x48\", 36 SF/ctn", "price": "$2.67/SF"},
    {"service": "Armstrong Unify 20mil Tile — LVT Commercial, 18\"x18\", 36 SF/ctn", "price": "$2.67/SF"},
    ...
    {"service": "Timbertones 3/8\"x6.5\" Engineered Hardwood — 34 SF/ctn (Call for project pricing)", "price": "CALL"},
    {"service": "Timbertones 1/2\"x7.5\" Engineered Hardwood — 29.5 SF/ctn (Call for project pricing)", "price": "CALL"},
    {"service": "Timbertones 7/16\"x7.5\" Engineered Hardwood — 28 SF/ctn (Call for project pricing)", "price": "CALL"},
    {"service": "Timbertones 1/2\"x8.5\" Engineered Hardwood — 32 SF/ctn (Call for project pricing)", "price": "CALL"},
    {"service": "Timbertones Reducer Molding — 78\"", "price": "$63.96/ea"},
    {"service": "Timbertones Threshold Molding — 78\"", "price": "$104.47/ea"},
    {"service": "Timbertones T-Molding — 78\"", "price": "$68.22/ea"},
    {"service": "Timbertones Quarter Round — 78\"", "price": "$27.72/ea"},
    {"service": "Timbertones Flush Stair Nose — 78\"", "price": "$104.47/ea"},
    {"service": "Armstrong S202-108 Static Dissipative Tile Adhesive — 150 SF/gal", "price": "$183.09/ea"},
    {"service": "Armstrong S202-418 Static Dissipative Tile Adhesive 4-gal", "price": "$402.84/pail"},
    {"service": "Armstrong S-515-408 Clear Thin Spread Adhesive Gallon — 350-400 SF/gal", "price": "$24.10/gal"},
    {"service": "Armstrong S515-418 Clear Thin Spread Adhesive 4-gal", "price": "$79.91/pail"},
    {"service": "Armstrong 00SPR601 Spray Adhesive 22oz — 140-170 SF/gal", "price": "$45.48/ea"},
    {"service": "Armstrong S319-108 LVT Adhesive — 300-400 SF/gal", "price": "$53.63/ea"},
    {"service": "Armstrong S319-418 LVT Adhesive 4-gal", "price": "$200.19/pail"},
    {"service": "Armstrong S995-108 LVT Adhesive Gallon — 225-275 SF/gal", "price": "$69.41/gal"},
    {"service": "Armstrong S995-418 LVT Adhesive 4-gal — 225-275 SF/gal", "price": "$213.37/pail"},
    {"service": "Armstrong S-1000-208 LVT Adhesive 2-gal — 220-260 SF/gal", "price": "$275.56/pail"},
    {"service": "Armstrong S-995 Sheet Vinyl Adhesive Gallon — 220-260 SF/gal", "price": "$69.41/gal"},
    {"service": "Armstrong S-995 Sheet Vinyl Adhesive 4-gal", "price": "$213.37/pail"},
    {"service": "Armstrong S-1000 Sheet Vinyl Adhesive 2-gal — 220-260 SF/gal", "price": "$275.56/pail"},
    ...
    {"service": "Armstrong Floor Polish S480-408 Gallon — 1500-2000 SF coverage", "price": "$37.28/gal"},
    ...
    {"service": "Armstrong S185-418 Latex Primer — 4 gal, 400 SF", "price": "$69.86/ea"},
    {"service": "Armstrong S195-408 Underlayment Additive Gallon", "price": "$30.28/ea"},
    {"service": "Armstrong S725-125 Cove Base Adhesive — 30 oz, 50 lf/tube", "price": "$8.17/ea"},
    {"service": "Armstrong S725-418 Cove Base Adhesive — 4 gal, 300-350 lf/gal", "price": "$98.04/pail"}
  ]
},
{
  ...
  "effectiveDate": "2026-05-05",
  "items": [
    {"service": "AHF Mixed & Variegated Homogeneous Sheet — 6'7\" .080, Roll", "price": "$21.99/SY"},
    {"service": "AHF Mixed & Variegated Homogeneous Sheet — 6'7\" .080, Cut", "price": "$23.99/SY"},
    {"service": "AHF Concepts of Landscape Heterogeneous Sheet — 6'7\" .080, Roll", "price": "$21.99/SY"},
    {"service": "AHF Concepts of Landscape Heterogeneous Sheet — 6'7\" .080, Cut", "price": "$23.99/SY"},
    {"service": "AHF Distinct Inlaid Sheet — 6' .080, Roll", "price": "$19.99/SY"},
    {"service": "AHF Distinct Inlaid Sheet — 6' .080, Cut", "price": "$21.99/SY"},
    {"service": "AHF Nod to Nature Rewilding 2.5mm LVT Plank 7\"x48\" — Dry Back", "price": "$2.55/SF"},
    {"service": "AHF Nod to Nature Rewilding 2.5mm LVT Plank 9\"x60\" — Dry Back", "price": "$2.55/SF"},
    {"service": "AHF Nod to Nature Rewilding 2.5mm LVT Tile 12\"x24\" — Dry Back", "price": "$2.55/SF"},
    {"service": "AHF Nod to Nature Rewilding 2.5mm LVT Tile 16\"x32\" — Dry Back", "price": "$2.55/SF"},
    {"service": "AHF Nod to Nature Individuality 5.0mm LVT Plank 7\"x48\"", "price": "$3.90/SF"},
    {"service": "AHF Nod to Nature Individuality 5.0mm LVT Plank 9\"x60\"", "price": "$3.90/SF"},
    {"service": "AHF Nod to Nature Individuality 5.0mm LVT Tile 12\"x24\"", "price": "$3.90/SF"},
    {"service": "AHF Nod to Nature Individuality 5.0mm LVT Tile 16\"x32\"", "price": "$3.90/SF"},
    {"service": "AHF Nod to Nature USA 4.5mm LVT Plank 9\"x48\" — Call for project pricing", "price": "CALL"},
    {"service": "AHF Nod to Nature USA 2.5mm LVT Plank 9\"x48\" — Call for project pricing", "price": "CALL"},
    {"service": "AHF Nod to Nature USA 2.5mm LVT Tile 6\"x48\"", "price": "CALL"},
    {"service": "AHF Nod to Nature USA 2.5mm LVT Tile 18\"x18\"", "price": "CALL"},
    {"service": "AHF Nod to Nature USA 2.5mm LVT Tile 18\"x36\"", "price": "CALL"},
    {"service": "AHF Nod to Nature USA 2.5mm LVT Tile 12\"x24\"", "price": "CALL"},
    {"service": "AHF Expressive Ideas VBT Tile 12\"x12\"x.100\" — 36.04 SF/ctn", "price": "$2.29/SF"},
    {"service": "AHF Iliad VCT 12\"x12\"x1/8\" — 45 SF/ctn", "price": "$2.28/SF"},
    {"service": "AHF Highlights VCT 12\"x12\"x1/8\" — 45 SF/ctn", "price": "$2.28/SF"},
    {"service": "Bruce Bondlink Adhesive 4-gal WFTBRUCE-BLINK-4 — 220-260 SF/gal", "price": "$137.90"},
    {"service": "Bruce Bondlink Adhesive 1-gal WFTBRUCE-BLINK-1 — 220-260 SF/gal", "price": "$37.52"},
    {"service": "Bruce Apex Pro 2-gal WFTBRUCE-APRO-2 — 220-260 SF/gal", "price": "$171.25"},
    ...
    {"service": "AHF S995-108 LVT Adhesive Gallon — 220-260 SF/gal", "price": "$69.41/gal"},
    {"service": "AHF S995-418 LVT Adhesive 4-gal", "price": "$213.37/pail"},
    {"service": "AHF S-515-408 Clear Thin Spread Gallon — 350-400 SF/gal", "price": "$24.10/gal"},
    {"service": "AHF S515-418 Clear Thin Spread 4-gal", "price": "$79.91/pail"},
    {"service": "AHF S319-108 LVT Adhesive — 300-400 SF/gal", "price": "$53.63/ea"},
    {"service": "AHF S319-418 LVT Adhesive 4-gal", "price": "$200.19/pail"},
    {"service": "AHF S-1000-208 LVT Adhesive 2-gal — 220-260 SF/gal pH 5-14", "price": "$275.56"},
